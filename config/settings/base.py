...
APPS_DIR = ROOT_DIR.child('workolist')
...
DATABASES = {
    'default': config(
        'DATABASE_URL', default='sqlite:///' + ROOT_DIR.child('db.sqlite3'), cast=db_url
    )
}
...
ADMINS = [("""Lucas Souto""", 'lucasinfologos@gmail.com')]
